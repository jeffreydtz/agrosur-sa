...
// --- Final ---
function FinalScreen({ estado, onVerInforme }) {
...
function InformeScreen({ estado, onReiniciar, ctaTexto, onCta }) {
...
function Posiciones({ jugadores, onReiniciar, onVerInforme }) {
...
Object.assign(window, { FinalScreen, InformeScreen, Posiciones });
