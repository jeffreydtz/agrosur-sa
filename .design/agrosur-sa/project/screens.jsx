...
function ConceptoBox({ texto, presentacion }) {
  return (
...
// CÓMO JUGAR
// ============================================================
function ComoJugar({ onSiguiente }) {
  return (
...
// ============================================================
function ArquetipoCard({ arq, onElegir, seleccionado }) {
...
function ArquetipoSelect({ titulo, permitirAzar, onElegir, jugadorNum }) {
...
// ============================================================
function RondaView({ estado, carta, onAplicar, onSiguiente, modoPresentacion }) {
...
// EVENTO FIJO
// ============================================================
function EventoScreen({ estado, evento, onAplicar, onSiguiente }) {
...
Object.assign(window, {
  ClaseTag, ConceptoBox, Intro, ComoJugar, ModoSelect,
  ArquetipoCard, ArquetipoSelect, RondaView, EventoScreen,
});
